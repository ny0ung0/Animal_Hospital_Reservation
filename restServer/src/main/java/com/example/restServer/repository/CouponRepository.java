...
public interface CouponRepository extends JpaRepository<Coupon, Long> {
	...
	@Query(value="select * from coupon where user_id=:userId and hospital_id=:hospitalId and (ISNULL(is_used) OR is_used =FALSE) AND expiry_date>= now()", nativeQuery=true)
